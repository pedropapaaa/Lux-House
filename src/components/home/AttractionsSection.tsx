...
const AttractionsSection = memo(function AttractionsSection() {
  ...
  const cards = isComingSoon || schedule.length === 0
    ...
    : schedule.map((s, i) => ({
        ...
        accent: ['#FF8C2E', '#5B9BD5', '#D4842E'][i % 3],
        badge: i === 0 ? 'DESTAQUE' : null,
      }));

  return (
    <section id="atrações" className="py-16 sm:py-24 sm:py-32 lg:py-40 px-4 sm:px-6 relative bg-dark-900">
      {!isMobile && (
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl sm:text-5xl lg:text-7xl font-bold text-white uppercase tracking-tight mb-3 sm:mb-4">
            ATRAÇÕES{' '}
            <span
              className="block"
              style={{
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-3 text-white/40 text-xs sm:text-sm sm:text-base">
            {isComingSoon ? (
              ...
              >
                ...
                >
                  ...
                  <div className="p-4 sm:p-6 lg:p-8">
                    ...
                    <h3 className="text-lg sm:text-2xl font-bold text-white mb-2 sm:mb-3 group-hover:text-pink-400 transition-colors duration-300">
                      {a.artist}
                    </h3>

                    {a.description && <p className="text-white/40 text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4">{a.description}</p>}
