  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <motion.div
        ...
        style={{
          boxShadow: '0 0 60px rgba(139, 92, 246, 0.15), 0 20px 40px rgba(0, 0, 0, 0.4)',
        }}
      >
        ...
        <div className="bg-dark-900 rounded-2xl sm:rounded-3xl">
          ...
          <div className="relative px-5 sm:px-8 pt-8 sm:pt-10 pb-6 sm:pb-8 text-center border-b border-white/5">
            ...
            <div className="absolute inset-0 opacity-[0.03]"
              style={{ backgroundImage: 'radial-gradient(circle at 50% 50%, #8B5CF6 1px, transparent 1px)', backgroundSize: '20px 20px' }}
            />
            ...
            <div className="relative">
              ...
              <div className="font-script text-5xl sm:text-6xl text-gradient-primary mb-2">Lux House</div>
          ...
          <div className="px-5 sm:px-8 py-5 sm:py-6 space-y-3 sm:space-y-4">
            {[
              { icon: User, label: 'Comprador', value: ticket.buyer_name, color: '#8B5CF6' },
              { icon: TicketIcon, label: 'Lote', value: ticket.lot_name, color: '#FF5A00' },
              { icon: Calendar, label: 'Data', value: ticket.event_date, color: '#38BDF8' },
              { icon: Clock, label: 'Horário', value: ticket.event_time, color: '#A78BFA' },
              { icon: MapPin, label: 'Local', value: ticket.event_location, color: '#FF8A33' },
