...
const AttractionsSection = memo(function AttractionsSection() {
  ...
  const cards = isComingSoon || schedule.length === 0
    ...
    : schedule.map((s, i) => ({
        ...
        image: s.title === 'DJ Rayder' ? 'https://images.pexels.com/photos/5949086/pexels-photo-5949086.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop' : event?.photos?.[i % (event.photos.length || 1)] || `/images/files_10828746-2026-07-03T03-41-0${i % 3 + 4}13Z-image.png`,
