      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="h-px w-12 bg-gradient-to-r from-transparent to-magenta-500/60" />
            <span className="text-[10px] tracking-[0.5em] text-magenta-400/80 uppercase font-medium">Sobre Nos</span>
            <div className="h-px w-12 bg-gradient-to-l from-transparent to-magenta-500/60" />
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-24 items-center">
            ...
            <div className="relative rounded-2xl overflow-hidden">
              ...
              >
                <div className="p-4 sm:p-5 flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <div className="text-[9px] tracking-[0.3em] text-magenta-400/70 uppercase">Reconhecida como</div>
                    <div className="text-ivory font-bold text-sm">Melhor Casa de Show</div>
                    <div className="text-ivory/30 text-[10px] mt-0.5">Vinhedo - SP 2024</div>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          >
            <h3 className="text-xl sm:text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-ivory mb-4 sm:mb-6 leading-tight">
              Onde a noite{' '}
              <span
                style={{
                  background: 'linear-gradient(135deg, #7A00FF, #E90083)',
            ...
            <p className="text-ivory/50 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
            ...
            <p className="text-ivory/40 leading-relaxed mb-8 sm:mb-12 text-xs sm:text-sm">
              ...
              {stats.map(({ icon: Icon, label, value, accent }, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <div className="text-ivory/40 text-[11px] sm:text-xs sm:text-sm">{label}</div>
                  </div>
                </motion.div>
              ))}
            </div>
