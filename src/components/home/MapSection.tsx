...
const MapSection = memo(function MapSection() {
  ...
  return (
    <section id="local" className="py-16 sm:py-24 sm:py-32 lg:py-40 px-4 sm:px-6 relative overflow-hidden bg-dark-900">
      {!isMobile && (
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-5">
            <Zap size={16} className="text-purple-400" style={{ filter: isMobile ? 'none' : 'drop-shadow(0 0 8px #D4842E)' }} />
            <span className="text-[10px] tracking-[0.5em] text-purple-400/80 uppercase font-medium">Localizacao</span>
            <Zap size={16} className="text-pink-400" style={{ filter: isMobile ? 'none' : 'drop-shadow(0 0 8px #FF8C2E)' }} />
          </div>
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                boxShadow: isMobile ? 'none' : '0 0 40px rgba(255, 140, 46, 0.15)',
              }}
            >
              <iframe
          ...
          <div className="space-y-4 sm:space-y-5">
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-5">
                    ...
                    <div>
                      ...
                      <div className="text-white/70 text-xs sm:text-sm sm:text-base leading-relaxed">{content}</div>
                    </div>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              ...
              >
                <div
                  ...
                  style={{
                    background: 'rgba(9, 9, 9, 0.6)',
                    border: '1px solid rgba(212, 132, 46, 0.15)',
                  }}
                >
                  <div
                    className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center mb-3 sm:mb-4"
                    style={{
                      background: 'rgba(212, 132, 46, 0.15)',
                      boxShadow: isMobile ? 'none' : '0 0 20px rgba(212, 132, 46, 0.3)',
                    }}
                  >
                  ...
                  <div className="text-white/50 text-xs sm:text-sm">{isComingSoon ? COMING_SOON : 'Disponivel no local'}</div>
                </div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: isMobile ? 0 : 20 }}
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: isMobile ? 'none' : '0 0 20px rgba(91, 155, 213, 0.3)',
                    }}
                  >
                    <Train size={18} className="text-cyan-400 sm:!size-5" />
                  </div>
                  <div className="text-[9px] sm:text-[10px] tracking-widest text-cyan-400/70 uppercase mb-1 sm:mb-1.5 font-medium">Acesso</div>
                  <div className="text-white/50 text-xs sm:text-sm">{isComingSoon ? COMING_SOON : 'Seguir instruçoes no local'}</div>
                </div>
              </motion.div>
            </div>
            ...
            >
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(255, 140, 46, 0.1), rgba(212, 132, 46, 0.1))',
                  border: '2px solid rgba(255, 140, 46, 0.25)',
                  boxShadow: isMobile ? 'none' : '0 0 40px rgba(255, 140, 46, 0.15)',
                }}
              >
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: isMobile ? 'none' : '0 0 20px rgba(255, 140, 46, 0.4)',
                    }}
                  >
                    <Calendar size={16} className="text-white sm:!size-4" />
                  </div>
                  <div className="text-[9px] sm:text-[10px] tracking-[0.3em] text-pink-400 uppercase font-bold">Data do Evento</div>
                </div>
                <div className="text-2xl sm:text-3xl sm:text-4xl font-bold text-white mb-2">
                  {isComingSoon ? COMING_SOON : (weekday && day && monthName ? `${weekday}, ${day} de ${monthName}` : COMING_SOON)}
                </div>
                <div className="text-white/40 text-xs sm:text-sm tracking-widest">{isComingSoon ? COMING_SOON : (event?.event_time || '--H')}</div>
              </div>
            </motion.div>
          </div>
        </div>
