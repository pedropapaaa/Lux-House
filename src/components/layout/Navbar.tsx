      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          {onBuyClick && canBuy ? (
            ...
            <Link
              to="/"
              className="px-5 py-2.5 rounded-xl border border-magenta-500/40 text-magenta-400 text-xs tracking-widest uppercase hover:border-magenta-400 hover:bg-magenta-500/10 transition-all duration-300"
            >
              Inicio
            </Link>
          )}
            ...
            >
              {isHome && links.map((l, i) => (
                <motion.button
                  ...
                  className="text-left text-xs sm:text-sm tracking-widest uppercase text-ivory/50 hover:text-magenta-400 transition-colors py-2.5 px-3 rounded-lg hover:bg-white/5"
                >
                  {l.label}
                </motion.button>
              ))}
              <div className="h-px bg-ivory/5 my-2" />
              {onBuyClick && canBuy && (
                <motion.button
              ...
              <Link
                to="/meus-ingressos"
                className="text-xs sm:text-sm text-ivory/40 hover:text-magenta-400 tracking-wide py-2.5 px-3 rounded-lg hover:bg-white/5 flex items-center gap-2"
              ...
              <Link
                to="/admin"
                className="text-xs sm:text-sm text-ivory/25 tracking-wide py-2.5 px-3 rounded-lg hover:bg-white/5"
                onClick={() => setOpen(false)}
              >
                Admin
              </Link>
